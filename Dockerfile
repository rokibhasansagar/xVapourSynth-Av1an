...
RUN <<-'EOL'
	...
	# llvm15-libs for vsakarin
	cd /home/app/.cache/paru/clone/ && paru --getpkgbuild llvm15-libs
	sed -i '/CMAKE_INSTALL_PREFIX/a\    -DCMAKE_C_COMPILER=clang\n    -DCMAKE_CXX_COMPILER=clang++\n    -DLLVM_TARGETS_TO_BUILD="AArch64;X86"' llvm15/PKGBUILD
	cd ./llvm15 && paru -Ui --noconfirm --needed ${PARU_OPTS} --mflags="--force" --rebuild && cd ..
